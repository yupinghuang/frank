...
if __name__ == '__main__':
    ...
    src1 = SkyCoord(ra='00h00m0.0s', dec='+37d07m47.000s')
    src2 = SkyCoord(ra='00h00m0.0s', dec='+37d37m47.000s')
    def sc_to_rad(sc):
        return [sc.ra.to(u.radian).value, sc.dec.to(u.radian).value]
    _, phases = h5parm_to_phases('/safepool/yuping/sim_dsa2000W_dawn_30.0_1.5_1src.h5') 
    src_lm = radec_to_lm(
